'use client';
import styles from '@/styles/components/overview/Sidebar.module.css';
...
const Sidebar = ({ sidebarOpen, onToggleSidebar }) => {
  ...
  return (
    ...
    >
      <div
        className={`${styles.logo} ${sidebarOpen ? styles['logo--open'] : styles['logo--closed']}`}
      >
        <Image
          ...
          width="121"
          height="24"
          className={`${styles['logo-large']} ${!sidebarOpen ? styles['logo-hidden'] : styles['logo-visible']}`}
        />
      ...
      <div className={styles.nav}>
        <nav>
          <button
            className={`${styles.btn} ${selectedButton === 'overview' ? styles['btn--active'] : styles['btn--inactive']}`}
          ...
          >
            ...
            <span
              className={`${styles.name} ${sidebarOpen ? styles['name-visible'] : styles['name-hidden']} text-3`}
            >
              Overview
            </span>
          </button>
          ...
          <button
            className={`${styles.btn} ${selectedButton === 'transactions' ? styles['btn--active'] : styles['btn--inactive']}`}
          ...
          <button
            className={`${styles.btn} ${selectedButton === 'budgets' ? styles['btn--active'] : styles['btn--inactive']}`}
        ...
        <div className={styles.minimize}>
          ...
          >
            <svg
              ...
              width="24"
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${sidebarOpen ? null : styles['minimize--closed']}`}
            >
