import styles from '@/styles/components/transactions/TransactionsFilters.module.css';
    ...
    <div className={styles.filters}>
      ...
      <div className={styles.sort}>
        ...
        {/* <div className={styles.dropdown}>
          <button className={styles['dropdown-button']}>Latest</button>
          <ul className={styles['dropdown-menu']}>
            <li>
              <a href="#" data-value="latest">
                Latest
              </a>
            </li>
          </ul>
